        ...
        <div className="flex flex-wrap sm:flex-nowrap items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="relative w-full sm:w-auto sm:flex-1 sm:max-w-md order-3 sm:order-2">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="w-full rounded-full border-2 border-blue-500 text-gray-800 py-2 pl-10 pr-4 focus:outline-none focus:ring-1 focus:ring-blue-200 text-sm sm:text-base md:text-base md:py-1.5"
            />
          </div>
